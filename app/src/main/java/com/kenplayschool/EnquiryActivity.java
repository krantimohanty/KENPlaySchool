...
import com.kenplayschool.fragment.menu_fragment.EnquiryFragment;
    ...
    private void setupViewPager(ViewPager viewPager) {
        {
            ...
            adapter.addFragment(new EnquiryFragment(), "");
...
//                        .sizeDp(20));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_enquiry) {
            startActivity(new Intent(EnquiryActivity.this, CreateEnquiryActivity.class));
            return true;
        }
