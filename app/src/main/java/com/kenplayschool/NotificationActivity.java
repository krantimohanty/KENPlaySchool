...
import com.kenplayschool.app_adapter.NotificationAdapter;
...
import com.kenplayschool.data_model.NotificationDataModel;
...
//            clearData();
    ...
    public void getNewNotification(int rowId, int pageCount, int user_id) {
        ...
        Log.d("Notification_url",AppServiceUrl.url + "/getNotifications1/" + user_id + "/" + rowId + "/" + pageCount);

        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, AppServiceUrl.url + "/getNotifications1/" + user_id + "/" + rowId + "/" + pageCount, null, new Response.Listener<JSONObject>() {
            @Override
    ...
    public void loadOfflineLocationData(int userid, int rowId, int pageCount) {
        ...
        //Url
        String url = AppServiceUrl.url + "/getNotifications1/" + userid + "/" + rowId + "/" + pageCount;
