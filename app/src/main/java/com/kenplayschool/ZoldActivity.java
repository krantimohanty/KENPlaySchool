...
import com.kenplayschool.app_adapter.PerformanceAdapter;
...
public class ZoldActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mRecyclerView.addItemDecoration(new DividerItemDecoration(ZoldActivity.this, DividerItemDecoration.VERTICAL_LIST));
        mRecyclerView.setHasFixedSize(true);

        achievementsAdapter = new PerformanceAdapter();

        LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(ZoldActivity.this);
    ...
    public void getSectors() {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, AppServiceUrl.url + "/getSectors1", null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                achievementsAdapter = new PerformanceAdapter(sectoralModels, ZoldActivity.this, mRecyclerView);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                pgBar.setVisibility(View.GONE);
                Custom_app_util.customSnackbar("Something went wrong!!!", ZoldActivity.this, false, "");
            }
        });
        ...
        VolleySingleton.getInstance(ZoldActivity.this).addToRequestQueue(jsonObjReq);
    }
